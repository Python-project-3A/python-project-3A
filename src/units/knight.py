...
class Knight(Unit):
    def __init__(self, owner: int, x: float, y: float, r: float, max_hp: int, armor: int, damage: int, attack_range: float, attack_cooldown: float, speed: float, name: str = "Knight"):
